    ...
    <div className="w-full  h-auto flex justify-center items-center">
      ...
      >
        ...
        <p className="text-center max-w-3xl mx-auto text-muted-foreground poppins-regular">
          At RONEL LEX ADVOCATES AND CONSULTANTS, we believe in the importance
          of continuous education and knowledge sharing. Our Knowledge Hub is
            ...
            <Card>
              <CardContent className="space-y-4 p-6">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Recent Legislative Changes:</strong> Insights into
                    new laws and how they impact individuals and businesses.
                  </li>
                  <li>
          ...
          <TabsContent value="reports" className="mt-20 sm:mt-0">
            <Card>
              <CardContent className="space-y-4 p-6">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Case Background:</strong> Contextual information
                    about the case.
                  </li>
                  <li>
            ...
            <Card>
              <CardContent className="space-y-4 p-6">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Research Articles:</strong> Detailed articles
                    authored by our team and guest contributors.
                  </li>
                  <li>
                    <strong>Legal Briefs:</strong> Concise documents outlining
                    key legal issues and strategies.
                  </li>
                </ul>
                <p>
                  Download our resources to enhance your legal understanding.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
