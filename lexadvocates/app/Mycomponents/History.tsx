    ...
    <div className="sm:m-10 m-5">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          advocates brings together a wealth of knowledge across diverse areas
          of law, from corporate and commercial litigation to constitutional and
          criminal defense. This multi-disciplinary strength allows us to craft
          innovative strategies for complex legal challenges.
        </li>
        <li>
          <b>Client-Centric Solutions:</b> Understanding that no two cases are
          the same, we tailor our legal services to meet the specific needs and
          objectives of each client. By maintaining open communication and
          transparency throughout the process, we ensure that our clients are
          well-informed and involved at every stage of their legal journey.
        </li>
        <li>
          <b>Commitment to Excellence:</b> We are dedicated to upholding the
          highest standards of legal practice, consistently delivering quality
          work and ethical representation. Our relentless pursuit of excellence
          is supported by rigorous research, thorough case preparation, and
          staying abreast of the latest legal developments and amendments.
        </li>
        <li>
          <b>Adaptability and Innovation:</b> In an ever-evolving legal
          landscape, we pride ourselves on our ability to adapt swiftly to
          changes in laws, regulations, and judicial interpretations. Leveraging
          technology and modern legal tools, we provide cutting-edge solutions
          that address contemporary legal challenges, including the latest
          amendments in areas such as data privacy, cyber law, and corporate
          governance.
        </li>
        <li>
          <b>Alternative Dispute Resolution (ADR):</b> Where appropriate, we
          advocate for efficient, cost-effective methods of resolving disputes
          through mediation, arbitration, and negotiation, prioritizing amicable
